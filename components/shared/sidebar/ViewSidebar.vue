...
import MobileResizableDrawer from "@/components/shared/sidebar/MobileResizableDrawer.vue";
    ...
    <div class="relative min-h-full">
      ...
      <div class="p-4 sidebar-content">
        ...
        <MapIntroPanel
          ...
          :export-min-date="mapDateMin"
          :export-max-date="mapDateMax"
          :export-timestamp-column="timestampColumn"
          :logo-url="logoUrl"
