 ...
 * @param entries - Optional array of collection entries to add. Each entry must include
 * feature_type ("alert" | "secondary") so the server uses alert_id for alerts and _id
 * for secondary rows.
 ...
 * @param entries - Array of entries to add; each must include feature_type
 * ("alert" | "secondary") so the server uses alert_id or _id
