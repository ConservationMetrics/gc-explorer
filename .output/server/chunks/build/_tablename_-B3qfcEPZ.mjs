...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, error } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/${table}/alerts`, {
      headers
    }, "$6he-z8_BBy")), __temp = await __temp, __restore(), __temp);
    ...
    const { t } = useI18n();
    useHead({
      title: "GuardianConnector Explorer " + t("changeDetectionAlerts") + " - " + replaceUnderscoreWithSpace(table)
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/alerts/[tablename].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_tablename_-B3qfcEPZ.mjs.map
