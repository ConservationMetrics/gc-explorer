...
import { b as buildAssetsURL, u as useRuntimeConfig, a as getResponseStatusText, c as getResponseStatus, e as defineRenderHandler, p as publicAssetsURL, f as getQuery, h as createError, i as getRouteRules, j as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[{"src":"/vendor/lightbox/lightbox-plus-jquery.js","defer":true}],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
